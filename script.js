...
app.post('/api/meu-cartao/consultar', async (req, res) => {
  ...
  try {
    ...
    console.log('✅ ENCONTRADO:', data.nome_aluno);
    res.json({
      sucesso: true,
...
app.listen(PORT, '0.0.0.0', () => {
  console.log('\n========================================');
  console.log('🚌 SISTEMA DO CARTÃO SESI/SENAI');
  console.log('========================================');
  console.log(`✅ Servidor: http://localhost:${PORT}`);
  console.log(`✅ Teste: http://localhost:${PORT}/api/teste`);
  console.log(`✅ Listar: http://localhost:${PORT}/api/meu-cartao/listar-todos`);
  console.log('========================================\n');
});